# from ..archive import classify, reports, savings_plan
from fastapi import FastAPI, Depends
from .routes import auth, ingest, categories, coach, forecast, budgets, goals, accounts_budget, accounts_savings
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],          # or ["http://localhost:8080","http://127.0.0.1:8080"]
